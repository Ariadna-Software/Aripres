...
Private Sub cmdCta_Click()
      ...
      SQL = "Codigo|idbaja|N||20·"
      SQL = SQL & "Descripcion|descbaja|T||70·"
      Set frmB = New frmBuscaGrid
      frmB.vCampos = SQL
      frmB.vDevuelve = "0|1|"
      frmB.vTabla = "tipobaja"
      frmB.vTitulo = "Tipos baja"
      SQL = "2"
      frmB.Show vbModal
      Set frmB = Nothing
      If SQL <> "" Then
...
Private Sub cmdT_Click()
    ...
    If SQL <> "" Then
        ...
        txtAux(3).Text = RecuperaValor(SQL, 1)
        txtAux(4).Text = RecuperaValor(SQL, 2)
    End If
End Sub
