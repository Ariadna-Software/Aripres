...
Begin VB.Form frmSeccion 
   ...
   Begin VB.ComboBox Combo1 
      Height          =   315
      Index           =   1
      ItemData        =   "frmSeccion.frx":000C
      Left            =   8760
      List            =   "frmSeccion.frx":0016
      Style           =   2  'Dropdown List
      TabIndex        =   4
      Tag             =   "Nomi. ariadna|N|N|0||secciones|nominas|||"
      Top             =   4920
      Width           =   735
   End
   Begin VB.ComboBox Combo1 
      ...
      Style           =   2  'Dropdown List
      TabIndex        =   3
      Tag             =   "Control|N|N|0||secciones|controlempleados|||"
      Top             =   4920
      Width           =   1335
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   6
      TabIndex        =   2
      Tag             =   "Calendario|N|N|0||secciones|idCal|0||"
      Text            =   "Dat"
      Top             =   4920
      Width           =   800
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   1
      Tag             =   "Descripción|T|N|||secciones|nombre|||"
      Text            =   "Dato2"
      Top             =   4920
      Width           =   2835
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   0
      Tag             =   "Código|N|N|0||secciones|idseccion|0|S|"
      Text            =   "Dat"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmSeccion.frx":0022
      Height          =   4635
      Left            =   240
      TabIndex        =   11
      Top             =   540
...
Dim anc As Single
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("secciones", "idseccion")
    End If
    '********************************************************************
...
Private Sub BotonModificar()
    ...
    I = adodc1.Recordset!controlempleados
    PosicionarCombo Combo1(0), I
    I = adodc1.Recordset!nominas
...
'Dim temp As Boolean
    ...
    If MsgBox(SQL, vbQuestion + vbYesNo) = vbYes Then
        ...
        SQL = "Delete from secciones where idseccion=" & adodc1.Recordset!idseccion
        Conn.Execute SQL
        If CadB <> "" Then
            CargaGrid CadB
...
Private Sub btnBuscar_Click(Index As Integer)
    ...
    frmB.vCampos = "Codigo|idcal|N||25·Descripción|Descripcion|T||75·"
    frmB.vDevuelve = "0|1|"
    frmB.vSelElem = 0
    frmB.vTitulo = "Calendarios"
    frmB.Show vbModal
    Set frmB = Nothing
    ...
    If PrimeraVez Then
        ...
        Else
            ...
            If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "idseccion =" & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "select idseccion,nombre,secciones.idcal,descripcion,controlempleados,desccontrol,if(nominas=0,""No"",""Si""),nominas"
    CadenaConsulta = CadenaConsulta & " from secciones,calendario,stipocontrol where calendario.idcal=secciones.idcal and  controlempleados = tipocontrol"
...
Private Sub frmB_Selecionado(CadenaDevuelta As String)
    ...
    txtAux2(2).Text = RecuperaValor(CadenaDevuelta, 2)
End Sub
...
'    adodc1.ConnectionString = Conn
    ...
    tots = "S|txtAux(0)|T|Código|600|;S|txtAux(1)|T|Nombre|2600|;S|txtAux(2)|T|Cal.|600|;S|btnBuscar(0)|B||0|;S|txtAux2(2)|T|Calendario|2500|;"
    tots = tots & "N||||0|;S|Combo1(0)|C|Código|1200|;S|Combo1(1)|C|Nomina|700|;N|||||;"
...
Dim C As String
    ...
    Case 2
        ...
        If txtAux(2).Text <> "" Then
            C = DevuelveDesdeBD("descripcion", "calendario", "idcal", txtAux(2).Text, "N")
        End If
        txtAux2(2).Text = C
...
Dim B As Boolean
    ...
    If txtAux2(2).Text = "" Then
        MsgBox "Horario incorrecto", vbExclamation
        Exit Function
    End If
    ...
    If Modo = 3 Then
        ...
        'la N es pa dir que es numeric
         ...
         Datos = DevuelveDesdeBD("idseccion", "secciones", "idseccion", txtAux(0).Text, "N")
         If Datos <> "" Then
            MsgBox "Ya existe la sección: " & txtAux(0).Text, vbExclamation
            DatosOk = False
            PonerFoco txtAux(0)
            Exit Function
        End If
...
Private Function SepuedeBorrar(ByRef C As String) As Boolean
    ...
    C = DevuelveDesdeBD("idtrabajador", "Trabajadores", "seccion", CStr(adodc1.Recordset!idseccion), "T")
    If C <> "" Then
        MsgBox "Existen trabajadores pertenecientes a esta seccion", vbExclamation
    Else
        SepuedeBorrar = True
    End If
...
'
'        miSQL = "INSERT INTO stipocontrol (tipocontrol,desccontrol) VALUES "
'        miSQL = miSQL & "(1,'Exahistivo'),(2,'Horas'),(3,'Libre')"
'        Conn.Execute miSQL
