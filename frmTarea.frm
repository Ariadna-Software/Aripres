...
Begin VB.Form frmTarea 
   ...
   Begin VB.ComboBox Combo1 
      Height          =   315
      Index           =   0
      ItemData        =   "frmTarea.frx":000C
      Left            =   5040
      List            =   "frmTarea.frx":000E
      Style           =   2  'Dropdown List
      TabIndex        =   3
      Tag             =   "Horario|N|N|0||tareas|tipo|||"
      Top             =   4920
      Width           =   1335
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   6
      TabIndex        =   2
      Tag             =   "Tarjeta|T|N|||Tareas|tarjeta|||"
      Top             =   4920
      Width           =   1635
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   1
      Tag             =   "Descripción|T|N|||tareas|descripcion|||"
      Top             =   4920
      Width           =   2835
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   6
      TabIndex        =   0
      Tag             =   "Código|N|N|0||Tareas|idTarea|0|S|"
      Top             =   4920
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmTarea.frx":0010
      Height          =   6195
      Left            =   240
      TabIndex        =   9
      Top             =   540
    ...
    If PrimeraVez Then
        ...
        Else
            ...
            If Me.CodigoActual <> "" Then
                SituarData Me.adodc1, "idtarea =" & CodigoActual, "", True
            End If
        End If
    End If
End Sub
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "select idtarea,descripcion,tarjeta,tipo,if(tipo=0,""Normal"",""Salida"")"
    CadenaConsulta = CadenaConsulta & " from tareas"
...
'    adodc1.ConnectionString = Conn
    ...
    tots = "S|txtAux(0)|T|Código|700|;S|txtAux(1)|T|Descripcion|3000|;S|txtAux(2)|T|Tarjeta|1000|;"
