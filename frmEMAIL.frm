...
''    mailman.SmtpAuthMethod = "CRAM-MD5"
''    mailman.SmtpLoginDomain = mailman.SmtpUsername
'
''
...
'        email.AddTo "Soporte aripres", Cad
'
'        Cad = "Soporte AriPres. "
...
'        Cad = Cad & "Empresa: " & vEmpresa.NomEmpresa & vbCrLf
'        Cad = Cad & "&nbsp;<hr>"
...
'        If chkCopia.Value = 1 Then email.AddBcc "Ariconta: " & vEmpresa.NomEmpresa, RecuperaValor(Valores2, 1)
'    End If
'
...
'        email.FromName = "Administrador Aripres"
'    Else
