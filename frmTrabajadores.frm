...
Dim I As Integer
    ...
    If vEmpresa.QueEmpresa = 2 Then  'ALZIRA
...
Private Sub PonerCampos()
    ...
    If vEmpresa.QueEmpresa = 2 Then
        ...
        If vEmpresa.laboral Then CargaDatosBolsaHoras
    End If
...
Dim IT
    ...
    miSQL = "select Desctipohora,if(paraempresa=0,'Si','') Lacope,horasbolsa from trabajadoresbolsahoras,"
