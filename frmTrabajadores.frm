...
Begin VB.Form frmTrabajadores 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(0).Control(17)=   "Label4(20)"
      Tab(0).Control(17).Enabled=   0   'False
      Tab(0).Control(18)=   "Label4(36)"
      Tab(0).Control(18).Enabled=   0   'False
      Tab(0).Control(19)=   "Label4(37)"
      Tab(0).Control(19).Enabled=   0   'False
      Tab(0).Control(20)=   "Label4(38)"
      Tab(0).Control(20).Enabled=   0   'False
      Tab(0).Control(21)=   "imgFec(28)"
      Tab(0).Control(21).Enabled=   0   'False
      Tab(0).Control(22)=   "Label4(39)"
      Tab(0).Control(22).Enabled=   0   'False
      Tab(0).Control(23)=   "Text1(17)"
      ...
      Tab(0).Control(31)=   "Combo1(0)"
      Tab(0).Control(31).Enabled=   0   'False
      Tab(0).Control(32)=   "Combo1(1)"
      Tab(0).Control(32).Enabled=   0   'False
      Tab(0).Control(33)=   "FrameImagen"
      Tab(0).Control(33).Enabled=   0   'False
      Tab(0).Control(34)=   "Text1(9)"
      Tab(0).Control(34).Enabled=   0   'False
      Tab(0).Control(35)=   "Option1(0)"
      Tab(0).Control(35).Enabled=   0   'False
      Tab(0).Control(36)=   "Option1(1)"
      Tab(0).Control(36).Enabled=   0   'False
      Tab(0).Control(37)=   "Text1(11)"
      Tab(0).Control(37).Enabled=   0   'False
      Tab(0).Control(38)=   "Text1(12)"
      Tab(0).Control(38).Enabled=   0   'False
      Tab(0).Control(39)=   "Text1(18)"
      Tab(0).Control(39).Enabled=   0   'False
      Tab(0).Control(40)=   "Combo1(2)"
      Tab(0).Control(40).Enabled=   0   'False
      Tab(0).Control(41)=   "Text1(28)"
      Tab(0).Control(41).Enabled=   0   'False
      Tab(0).Control(42)=   "FrameTapaCtaBancaria"
      Tab(0).Control(42).Enabled=   0   'False
      Tab(0).Control(43)=   "FrameHuella"
      Tab(0).Control(43).Enabled=   0   'False
      Tab(0).Control(44)=   "Text1(34)"
      Tab(0).Control(44).Enabled=   0   'False
      Tab(0).Control(45)=   "Text1(35)"
      Tab(0).Control(45).Enabled=   0   'False
      Tab(0).Control(46)=   "cmdResetPassMovil"
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   100
         TabIndex        =   19
         Tag             =   "IdMovil|T|S|||trabajadores|pin|||"
         Top             =   1200
         Width           =   1335
      End
      Begin VB.CommandButton cmdResetPassMovil 
         Height          =   315
         Left            =   10680
         Picture         =   "frmTrabajadores.frx":0060
         Style           =   1  'Graphical
         TabIndex        =   120
         ToolTipText     =   "Resetear contraseña acceso movil"
         Top             =   1200
         Visible         =   0   'False
         Width           =   375
      End
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   100
         TabIndex        =   18
         Tag             =   "IdMovil|T|S|||trabajadores|codigo|||"
         Top             =   1200
         Width           =   1335
      End
      Begin VB.TextBox Text1 
      ...
      Begin VB.Frame Framelaboral 
         ...
         Begin VB.CheckBox Check1 
            ...
            Left            =   3240
            TabIndex        =   118
            Tag             =   "E|N|S|||trabajadores|embargo|||"
            Top             =   2640
            Width           =   1575
         End
         Begin VB.ComboBox Combo1 
            Height          =   315
            Index           =   5
            ItemData        =   "frmTrabajadores.frx":0A62
            Left            =   3480
            List            =   "frmTrabajadores.frx":0A6C
         ...
         Begin VB.ComboBox Combo1 
            Height          =   315
            Index           =   4
            ItemData        =   "frmTrabajadores.frx":0A78
            Left            =   240
            List            =   "frmTrabajadores.frx":0A7A
            Style           =   2  'Dropdown List
            TabIndex        =   67
         ...
         Begin VB.TextBox Text1 
            ...
            MaxLength       =   5
            TabIndex        =   62
            Tag             =   "PlusHN|N|S|0||trabajadores|PlusHN|0.00||"
            Top             =   1920
            Width           =   855
         End
         Begin VB.TextBox Text1 
            ...
            MaxLength       =   5
            TabIndex        =   63
            Tag             =   "Plus HEl|N|S|0||trabajadores|PlusHE|0.00||"
            Top             =   1920
            Width           =   855
         End
         Begin VB.TextBox Text1 
            ...
            Left            =   2520
            TabIndex        =   64
            Tag             =   "nomina fija|N|S|0||trabajadores|ImporteFijoNomina|#,##0.00||"
            Top             =   1920
            Width           =   1095
         End
         ...
         Begin VB.ComboBox Combo1 
            Height          =   315
            Index           =   3
            ItemData        =   "frmTrabajadores.frx":0A7C
            Left            =   240
            List            =   "frmTrabajadores.frx":0A7E
            TabIndex        =   61
         ...
         Begin VB.TextBox Text1 
            ...
            MaxLength       =   5
            TabIndex        =   71
            Tag             =   "IRPF|N|S|||trabajadores|porcIRPF|0.00||"
            Top             =   4080
            Width           =   975
         End
         Begin VB.TextBox Text1 
            ...
            MaxLength       =   5
            TabIndex        =   70
            Tag             =   "Seguridad social|N|S|||trabajadores|porcSS|0.00||"
            Top             =   4080
            Width           =   975
         End
         Begin VB.TextBox Text1 
            ...
            MaxLength       =   5
            TabIndex        =   69
            Tag             =   "antiguedad|N|S|||trabajadores|porcantiguedad|0.00||"
            Top             =   4080
            Width           =   975
         End
         Begin VB.Label Label4 
         ...
         Begin VB.Image imgFec 
            ...
            Index           =   27
            Left            =   840
            Picture         =   "frmTrabajadores.frx":0A80
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   28
         Left            =   2640
         Picture         =   "frmTrabajadores.frx":0B0B
         ToolTipText     =   "Buscar fecha"
         Top             =   5880
         Width           =   240
      End
      ...
      Begin VB.Image imgCalendariP 
         ...
         Index           =   0
         Left            =   -67080
         MouseIcon       =   "frmTrabajadores.frx":1598
         MousePointer    =   4  'Icon
      ...
      Begin VB.Image ImgModifHora 
         Height          =   240
         Left            =   -72960
         Picture         =   "frmTrabajadores.frx":16EA
         Top             =   600
         Width           =   240
      End
      Begin VB.Image imgZoom 
         ...
         Index           =   0
         Left            =   -73320
         MouseIcon       =   "frmTrabajadores.frx":20EC
         MousePointer    =   4  'Icon
      ...
      Begin VB.Image imgFec 
         ...
         Index           =   11
         Left            =   1560
         Picture         =   "frmTrabajadores.frx":223E
         ToolTipText     =   "Buscar fecha"
         Top             =   5880
         Width           =   240
      End
...
Dim HaCambiadoCentroTrabajo As Boolean
        ...
        Case 3 'INSERTAR
            If DatosOk Then
                If InsertarDesdeForm(Me) Then
                    ...
                    If vEmpresa.TieneCentrosA3 Then CentrosTrabajoA3_Datos
...
Private Sub cmdResetPassMovil_Click()
    If Modo <> 2 Then Exit Sub
    
    If DBLet(Data1.Recordset!Codigo, "T") = "" Then
        MsgBox "No tiene asignado usuario móvil", vbExclamation
        Exit Sub
    End If
    If DBLet(Data1.Recordset!numdni, "T") = "" Then
        MsgBox "No tiene el NIF. Indique uno", vbExclamation
        Exit Sub
    End If
    
    CadB = "Va establecer la contraseña:" & vbCrLf & "Usuario :" & Data1.Recordset!nomtrabajador
    CadB = CadB & vbCrLf & "Id movil :" & Data1.Recordset!Codigo
    CadB = CadB & vbCrLf & "Contraseña :" & Data1.Recordset!numdni
    CadB = CadB & vbCrLf & vbCrLf & "¿Continuar?"
    If MsgBox(CadB, vbQuestion + vbYesNoCancel) = vbYes Then
        CadB = "UPDATE trabajadores SET pin =" & DBSet(Data1.Recordset!numdni, "T") & " WHERE idtrabajador=" & Data1.Recordset!idTrabajador
        If EjecutaSQL(CadB) Then MsgBox "Contraseña establecida", vbInformation
...
Private Sub Combo1_Click(Index As Integer)
    ...
    If Index = 4 Then
        If Modo = 4 And vEmpresa.TieneCentrosA3 Then
            HaCambiadoCentroTrabajo = True
            PonerFoco Text1(22)
        End If
    End If
...
Dim I As Integer
    ...
    Label4(36).Visible = False
    Text1(34).Visible = False
    If vEmpresa.Reloj2 > 0 Then
        Label4(36).Visible = True
        Text1(34).Visible = True
        If vEmpresa.Reloj2 = 1 Then Label4(36).Caption = "Id Biostar"
    End If
...
Private Sub BotonAnyadir()
    ...
    If vEmpresa.laboral Then
        Text1(30).Text = Format(vEmpresa.IRPF_, FormatoPorcen)
...
Dim I As Integer
    ...
    'Lios campos PlusN plusE nomina fija SOLO valen, demeomento para CATADAU
    If vEmpresa.laboral Then
        
        If Trim(Text1(31).Text & Text1(32).Text & Text1(33).Text) <> "" Then
            If vEmpresa.QueEmpresa <> 4 Then
                MsgBox "Pluses NO implementados", vbExclamation
                Exit Function
            End If
        End If
    End If
...
'         End If
    ...
    If vEmpresa.TieneCentrosA3 Then
         If Combo1(4).ListIndex < 0 Then
            MsgBox "Seleccione un centro de trabajo", vbExclamation
            B = False
        End If
    End If
    ...
    If B And vEmpresa.Reloj2 > 0 Then
        Text1(34).Text = Trim(Text1(34).Text)
        If Text1(34).Text <> "" Then
            'Ha puesto identificador para el segundo reloj
            
            If vEmpresa.Reloj2 = 1 Then
                'El campo ID del reloj2 debe ser numerico
                If Not IsNumeric(Text1(34).Text) Then
                    MsgBox "Campo ID biostar debe ser numérico", vbExclamation
                    PonerFoco Text1(34)
                    
                    B = False
                Else
                    Text1(34).Text = Val(Text1(34).Text)
                    
                    'Compruebo que NO existe otro trabajador con este codigo
                    CadB = "idtrabajador <> " & Text1(0).Text & " AND idTraReloj2"
                    CadB = DevuelveDesdeBD("concat(idtrabajador,' ',nomtrabajador)", "trabajadores", CadB, Text1(34).Text, "T")
                    If CadB <> "" Then
                        MsgBox "Ya existe ese ID en el reloj BIostar2. " & vbCrLf & CadB, vbExclamation
                        B = False
                    End If
...
Dim C As String
    ...
    If Index = 4 Then
        If Modo = 4 And vEmpresa.TieneCentrosA3 And HaCambiadoCentroTrabajo Then
            Set RN = New ADODB.Recordset
            C = "Select * from trabajadorescentroa3 where idtrabajador =" & Data1.Recordset!idTrabajador
            C = C & " AND idcentro= " & Combo1(4).ItemData(Combo1(4).ListIndex)
...
Private Sub CargaCombo(Index As Integer)
    ...
    Select Case Index
        ...
        Case 4
            'Centros A3
            If vEmpresa.TieneCentrosA3 Then
                cad_meua = "SELECT * FROM CentrosA3  ORDER BY idCentro"
            Else
                cad_meua = "SELECT idempresa idcentro,nomempresa nomcentro FROM empresas "
            End If
            Set miRs = New ADODB.Recordset
            miRs.Open cad_meua, conn, adOpenForwardOnly, adLockOptimistic, adCmdText

            While Not miRs.EOF
                Combo1(Index).AddItem miRs!nomcentro
                Combo1(Index).ItemData(Combo1(Index).NewIndex) = miRs!idCentro
                miRs.MoveNext
            Wend
...
EIm:
    If Err.Number <> 0 Then
        MuestraError Err.Number, "Cargando huella:" & ErrorAcecionedoOCX, Err.Description
...
Private Sub CentrosTrabajoA3_Datos()
Dim C As String
    'Para cada centro de trabajo asignaremos unos datos
    C = "replace INTO trabajadorescentroa3(IdTrabajador,idCentro,idAsesoria,PorcAntiguedad,PorcSS,PorcIRPF)"
    C = C & "VALUES (" & Text1(0).Text & "," & Combo1(4).ItemData(Combo1(4).ListIndex) & ","
    C = C & DBSet(Text1(22).Text, "T") & "," & DBSet(Text1(19).Text, "N", "S") & ","
    C = C & DBSet(Text1(20).Text, "N", "S") & "," & DBSet(Text1(21).Text, "N", "S") & ")"
    EjecutaSQL C
End Sub
