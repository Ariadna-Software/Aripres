...
Public Sub LeerBinary(ADOField As ADODB.Field, img As Image)
    ...
    img.Picture = LoadPicture("pictemp")
...
Public Sub GuardarBinary(ADOField As ADODB.Field, unImage As Image)
