...
Begin VB.Form frmEmpresa 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(1).Control(0)=   "Label1(23)"
      Tab(1).Control(1)=   "Label3(4)"
      Tab(1).Control(2)=   "Label3(8)"
      Tab(1).Control(3)=   "Label3(9)"
      Tab(1).Control(4)=   "Label3(3)"
      Tab(1).Control(5)=   "Label1(31)"
      Tab(1).Control(6)=   "Image1"
      Tab(1).Control(7)=   "Label1(32)"
      Tab(1).Control(8)=   "Combo2"
      Tab(1).Control(9)=   "Check4"
      Tab(1).Control(10)=   "Check1(6)"
      Tab(1).Control(11)=   "Text1(25)"
      Tab(1).Control(12)=   "Frame3"
      Tab(1).Control(13)=   "Check3"
      Tab(1).Control(14)=   "Check2"
      Tab(1).Control(15)=   "Text1(29)"
      Tab(1).Control(16)=   "Text1(30)"
      Tab(1).Control(17)=   "Text1(34)"
      Tab(1).Control(18)=   "Combo3"
      Tab(1).Control(19)=   "Text1(37)"
      Tab(1).ControlCount=   20
      TabCaption(2)   =   "Presencia"
      TabPicture(2)   =   "frmEmpresa.frx":0044
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "Text1(38)"
      Tab(2).Control(1)=   "Text3(0)"
      Tab(2).Control(2)=   "Text1(31)"
      Tab(2).Control(3)=   "FrameTapaCortesia"
      Tab(2).Control(4)=   "Text3(1)"
      Tab(2).Control(5)=   "Text1(12)"
      Tab(2).Control(6)=   "Text1(13)"
      Tab(2).Control(7)=   "Text1(14)"
      Tab(2).Control(8)=   "Text1(15)"
      Tab(2).Control(9)=   "Text1(16)"
      Tab(2).Control(10)=   "Text2(0)"
      Tab(2).Control(11)=   "Text2(1)"
      Tab(2).Control(12)=   "Text2(2)"
      Tab(2).Control(13)=   "Text2(3)"
      Tab(2).Control(14)=   "Text2(4)"
      Tab(2).Control(15)=   "Text1(17)"
      Tab(2).Control(16)=   "Text1(18)"
      Tab(2).Control(17)=   "Combo1"
      Tab(2).Control(18)=   "Text1(19)"
      Tab(2).Control(19)=   "Text1(20)"
      Tab(2).Control(20)=   "Text1(21)"
      Tab(2).Control(21)=   "Text2(5)"
      Tab(2).Control(22)=   "Text1(24)"
      Tab(2).Control(23)=   "Label1(33)"
      Tab(2).Control(24)=   "Label1(16)"
      Tab(2).Control(25)=   "Label1(26)"
      Tab(2).Control(26)=   "Label1(11)"
      Tab(2).Control(27)=   "Label3(0)"
      Tab(2).Control(28)=   "Label1(12)"
      Tab(2).Control(29)=   "Label1(13)"
      Tab(2).Control(30)=   "Label1(14)"
      Tab(2).Control(31)=   "Label1(15)"
      Tab(2).Control(32)=   "Label1(17)"
      Tab(2).Control(33)=   "Label1(18)"
      Tab(2).Control(34)=   "Label3(1)"
      Tab(2).Control(35)=   "Label1(19)"
      Tab(2).Control(36)=   "Label1(20)"
      Tab(2).Control(37)=   "Label1(21)"
      Tab(2).Control(38)=   "Label1(22)"
      Tab(2).Control(39)=   "imgBuscar(0)"
      Tab(2).Control(40)=   "imgBuscar(1)"
      Tab(2).Control(41)=   "imgBuscar(2)"
      Tab(2).Control(42)=   "imgBuscar(3)"
      Tab(2).Control(43)=   "imgBuscar(4)"
      Tab(2).Control(44)=   "Line1"
      Tab(2).Control(45)=   "imgBuscar(5)"
      Tab(2).Control(46)=   "Label1(25)"
      ...
      Begin VB.TextBox Text1 
         ...
         Left            =   -66840
         TabIndex        =   38
         Tag             =   "Hora dia siguiente|H|S|||empresas|HoraDiaSiguiente|hh:nn||"
         Text            =   " "
         Top             =   3720
         Width           =   1095
      End
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   255
         TabIndex        =   115
         Tag             =   "1|T|S|||empresas|configreloj2|||"
         Top             =   2400
         Width           =   3735
      End
      Begin VB.ComboBox Combo3 
         ...
         Left            =   -73080
         List            =   "frmEmpresa.frx":00A2
         Style           =   2  'Dropdown List
         TabIndex        =   114
         Tag             =   "1|N|S|||empresas|reloj2|||"
         Top             =   2370
         Width           =   2895
      End
      ...
      Begin VB.ComboBox Combo2 
         Height          =   315
         ItemData        =   "frmEmpresa.frx":00B9
         Left            =   -73080
         List            =   "frmEmpresa.frx":00D2
         Style           =   2  'Dropdown List
         TabIndex        =   18
      ...
      Begin VB.ComboBox Combo1 
         Height          =   315
         ItemData        =   "frmEmpresa.frx":011C
         Left            =   -68400
         List            =   "frmEmpresa.frx":012C
         Style           =   2  'Dropdown List
         TabIndex        =   33
      ...
      Begin VB.Label Label1 
         AutoSize        =   -1  'True
         Caption         =   "Extiende jornada laboral dia siguiente"
         Height          =   195
         Index           =   33
         Left            =   -69600
         TabIndex        =   117
      ...
      Begin VB.Image Image1 
         Height          =   240
         Left            =   -73320
         Picture         =   "frmEmpresa.frx":016B
         Top             =   2400
         Width           =   240
      End
      Begin VB.Label Label1 
         Caption         =   "2º Tipo reloj"
         Height          =   255
         Index           =   31
         Left            =   -74760
         TabIndex        =   113
...
Dim NumReg As Byte
    ...
    B = False
    If vEmpresa.QueEmpresa > 0 Then B = Modo > 2  'FALTA####
    Me.Combo3.Enabled = B
    BloquearTxt Me.Text1(37), Not B
...
Private Sub Image1_Click()
    MsgBox "El control de los usuarios en el segundo tipo de reloj se realizará en el interfaz del mismo", vbExclamation
End Sub
...
Dim Aux As String
    ...
    Case 36, 38
        Text1(Index).Text = Trim(Replace(Text1(Index).Text, ".", ":"))
        If Text1(Index).Text <> "" Then
            If Not EsHoraOK(Text1(Index).Text) Then
                Text1(Index).Text = ""
                PonerFoco Text1(Index)
            Else
                Text1(Index).Text = Format(Text1(Index), "hh:nn:ss")
            End If
        End If
    End Select
...
'    text2(6).Text = PonerNombreDeCod(Text1(6), "poblacio", "despobla", "codpobla", "N")
    ...
    SSTab1.TabVisible(3) = Check3.Value
    SSTab1.TabVisible(4) = False 'Check2.Value
...
Dim cad As String
    ...
    If Combo3.ListIndex > 0 Then
        'Obligado el path
        If Trim(Text1(37).Text) = "" Then
            MsgBox "Debe indicar la el ODBC del BIostar2", vbExclamation    'De momento SOLO hay UNO reloj en el combo3
            B = False
        End If
    End If
    ...
    '3 Media Hora
    '0 Sin Redondear
    NumRegElim = CInt(Text1(19).Text)
    If NumRegElim = 0 And Combo1.ListIndex <> 3 Then
        cad = "Ponga minutos redondeo"
    Else
        Select Case Combo1.ListIndex
        Case 0
            If NumRegElim >= 10 Then cad = "X"
        Case 1
            If NumRegElim >= 15 Then cad = "X"
        
        Case 2
            If NumRegElim >= 30 Then cad = "X"
        Case Else
            cad = ""
        End Select
    ...
    If cad <> "" Then
        If cad = "X" Then cad = "Reondeo mayor igual intervalo. " & Combo1.Text
