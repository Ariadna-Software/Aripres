...
Begin VB.Form frmIncidencias 
   ...
   Begin VB.CheckBox Check1 
      ...
      Left            =   5280
      TabIndex        =   3
      Tag             =   "Ti|N|N|0||incidencias|excesodefecto|||"
      Top             =   4920
      Width           =   300
   End
   Begin VB.ComboBox Combo1 
      Height          =   315
      Index           =   0
      ItemData        =   "frmIncidencia.frx":000C
      Left            =   3840
      List            =   "frmIncidencia.frx":000E
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmIncidencia.frx":0010
      Height          =   6195
      Left            =   240
      TabIndex        =   9
      Top             =   540
...
Dim anc As Single
    ...
    If (DatosADevolverBusqueda <> "") And NuevoCodigo <> "" Then
        NumF = NuevoCodigo
    Else
        NumF = SugerirCodigoSiguienteStr("incidencias", "idinci")
    End If
    '********************************************************************
...
Private Sub BotonModificar()
    ...
    I = adodc1.Recordset!continuada
    PosicionarCombo Combo1(0), I
    I = adodc1.Recordset!excesodefecto
    Check1.Value = I
    LLamaLineas anc, 4
...
'Dim temp As Boolean
    ...
    If MsgBox(SQL, vbQuestion + vbYesNo) = vbYes Then
        ...
        SQL = "Delete from incidencias where idinci=" & adodc1.Recordset!idInci
        conn.Execute SQL
        
         
    
        ACtualizarIncidenciasEnReloj CStr(adodc1.Recordset!idInci)
        ...
        Case 3 'INSERTAR
            If DatosOk Then
                If InsertarDesdeForm(Me) Then
                    ...
                    'Si tiene relojes actualizamos las inicidencias grabables en el reloj
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    '****************** canviar la consulta *********************************+
    CadenaConsulta = "select idinci,nominci,if(continuada=0,""No"",""Si""),if(excesodefecto=0,"""",""*""),continuada,excesodefecto"
    CadenaConsulta = CadenaConsulta & " from incidencias"
...
'    adodc1.ConnectionString = Conn
    ...
    tots = "S|txtAux(0)|T|Código|700|;S|txtAux(1)|T|Descripcion|3000|;"
...
Dim B As Boolean
    ...
    If Modo = 3 Then
        ...
        'la N es pa dir que es numeric
         ...
         Datos = DevuelveDesdeBD("idinci", "incidencias", "idinci", txtAux(0).Text, "N")
         If Datos <> "" Then
            MsgBox "Ya existe la incidencia: " & txtAux(0).Text, vbExclamation
            DatosOk = False
            PonerFoco txtAux(0)
            Exit Function
        End If
...
Dim I As Integer
    ...
    'Veamos si estan en parametros
    C = CStr(adodc1.Recordset!idInci)

    cadSeleccion = ""
    If C = vEmpresa.IncHoraExceso Or _
        C = vEmpresa.IncHoraExtra Or _
        C = vEmpresa.IncMarcaje Or _
        C = vEmpresa.IncRetraso Or _
        C = vEmpresa.IncTarjError Or _
        C = vEmpresa.IncVacaciones Then cadSeleccion = "Esta en parametros"
        
        
    If cadSeleccion <> "" Then
        MsgBox cadSeleccion, vbExclamation
        cadSeleccion = ""
        Exit Function
    End If
    ...
    For I = 1 To 6
        C = RecuperaValor("entradafichajes|entradamarcajes|marcajes|marcajeshco|incidenciasgeneradas|incidenciasgeneradashco|", I)
        If I < 3 Then
            cadSeleccion = "idInci"
        ElseIf I < 5 Then
            cadSeleccion = "incFinal"
            
        ElseIf I = 5 Then
            cadSeleccion = "Incidencia"
        Else
            cadSeleccion = "Id"
        End If
        
        
        cadSeleccion = DevuelveDesdeBD("count(*)", C, cadSeleccion, CStr(adodc1.Recordset!idInci))
...
'    entradafichajes idInci
'    entradamarcajes idInci
'
'    marcajes IncFinal
'    marcajeshco IncFinal
'
'    incidenciasgeneradas Incidencia
'    incidenciasgeneradashco Id
...
'            Set miRs = Nothing
    ...
    Combo1(Index).AddItem "Si"
    Combo1(Index).ItemData(Combo1(Index).NewIndex) = 1
    
    Combo1(Index).AddItem "No"
...
Dim SQL As String
    ...
    OK = vEmpresa.QueEmpresa = 2
    
    
    If OK Then
        'Por si alguna NO se toca
        If Val(Me.txtAux(0).Text) < 10 Then OK = False
    End If
    ...
    If Incidencia_a_borrar = "" Then
        ...
        SQL = "SELECT CodInc,Valor FROM Incidencias WHERE CodInc =" & txtAux(0).Text
        Set RN = GesHuellaDB.cursor(SQL)
        If Not RN.EOF Then
            SQL = "UPDATE Incidencias set Valor = " & GesHuellaDB.Texto(txtAux(1).Text) & " WHERE CodInc = " & txtAux(0).Text
    
        Else
            'NUEVO
            SQL = "INSERT INTO Incidencias( CodInc,Valor) VALUES (" & txtAux(0).Text & "," & GesHuellaDB.Texto(txtAux(1).Text) & ")"
        End If
